...
const { appState, workspacesByPath, loading, openWorkspace } = useAppState()
...
<template>
  <div v-if="open" class="fixed inset-0 z-40 md:hidden">
    ...
    <aside
      class="absolute left-0 top-0 flex h-full w-[280px] flex-col overflow-hidden border-r border-gray-200 bg-white p-4 shadow-2xl dark:border-gray-800 dark:bg-gray-950"
    >
      <div class="flex items-center justify-between gap-2">
        <div class="text-sm font-black tracking-tight">Workspaces</div>
        <button
      ...
      <div class="mt-3 min-h-0 flex-1 overflow-y-auto overscroll-contain">
        <div class="relative">
          ...
          <input
            v-model="navQuery"
            class="w-full rounded-xl bg-gray-100 py-2 pl-10 pr-3 text-xs font-bold text-gray-800 outline-none ring-0 focus:ring-2 focus:ring-brand-500 dark:bg-gray-900 dark:text-gray-100"
        ...
        <div class="mt-4">
          ...
          <div v-else class="mt-2">
            <div
              ...
              class="rounded-xl border border-dashed border-gray-300 bg-gray-50 p-3 text-xs text-gray-600 dark:border-gray-800 dark:bg-gray-900 dark:text-gray-300"
            >
            ...
            <div v-else class="space-y-2">
              <div
                ...
                :class="w.path === activeWorkspacePath ? 'ring-1 ring-brand-500/30' : ''"
              >
            ...
            <div v-if="isWorkspaceExpanded(w.path) || w.forceExpanded" class="border-t border-gray-200 px-2 py-2 dark:border-gray-800">
              ...
              <div v-else class="rounded-xl bg-gray-50 p-3 text-[11px] text-gray-600 dark:bg-gray-950 dark:text-gray-300">
                Loading sessions…
              </div>
            </div>
              </div>
